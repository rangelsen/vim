...
syn match    matlabCustomParen    "(" contains=matlabParen,matlabCppParen
syn match    matlabCustomFunc     "\w\+\s*(" contains=matlabCustomParen
syn match    matlabCustomScope    "::"
syn match    matlabCustomClass    "\w\+\s*::" contains=matlabCustomScope

hi def link matlabCustomFunc  Function
hi def link matlabCustomClass Function
